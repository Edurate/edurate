...
def add_question(url):
    ...
    if response == 1:
        title = input("Enter a title for the question: ")
        ...
        choice1 = input("Enter first multiple choice answer: ")
        choice2 = input("Enter second multiple choice answer: ")
        choice3 = input("Enter third multiple choice answer: ")
        choice4 = input("Enter fourth multiple choice answer: ")
        form.addMultipleChoiceItem().setTitle(title).setChoiceValues([choice1,choice2,choice3,choice4]).showOtherOption(true);
